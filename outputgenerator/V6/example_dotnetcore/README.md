...
docker run --interactive --tty output-generator_example_dotnetcore --api-key "<YOUR-API-KEY>"
or
docker run --interactive --tty output-generator_example_dotnetcore --api-key "<YOUR-API-KEY>"
```
